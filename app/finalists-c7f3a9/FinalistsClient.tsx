...
const FINALISTS: { name: string; college: string }[] = [
  { name: "Aditi Singh",                  college: "" },
  { name: "Lakshya Goswami",              college: "IIT Ropar" },
  { name: "Atin Gupta",                   college: "IIT Guwahati" },
  { name: "Sonu Yadav",                   college: "" },
  { name: "Vaibhav Agarwal",              college: "" },
  { name: "Neev Mittal",                  college: "" },
  { name: "Aabhas Gupta",                 college: "" },
  { name: "Sashwath JS",                  college: "" },
  { name: "Khushhal Bansal",              college: "IIT Guwahati" },
  { name: "Ananya Prabhav",               college: "IIT BHU" },
  { name: "Rajarshi Nandi",               college: "" },
  { name: "Amogh Jalan",                  college: "" },
  { name: "Abishnavi T",                  college: "" },
  { name: "Ameya Tripathi",               college: "" },
  { name: "Surya Ramanathan M",           college: "" },
  { name: "Kashav Kumar",                 college: "" },
  { name: "Yashaswi Jain",                college: "" },
  { name: "Nishant",                      college: "IIT Kanpur" },
  { name: "Shaurya Johari",               college: "IIT Kanpur" },
  { name: "Guddanti Chetan Naga Anirudh", college: "" },
  { name: "Majid Husain",                 college: "" },
  { name: "Praneet Singh Bhatia",         college: "" },
  { name: "Anagh Atri",                   college: "" },
  { name: "Yash Bhardwaj",                college: "IIT Kanpur" },
  { name: "Yash Neeraj Sharma",           college: "" },
];
